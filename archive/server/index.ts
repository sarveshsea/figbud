...
📚 API Endpoints:
   ...
   GET  /analytics                   - Analytics dashboard (web UI)
   ...
   GET  /api/analytics/youtube-stats - YouTube API statistics
   GET  /api/analytics/chat-analytics - Chat session analytics
   GET  /api/analytics/health-metrics - Real-time health metrics
